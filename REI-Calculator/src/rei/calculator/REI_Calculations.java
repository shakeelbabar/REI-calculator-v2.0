...
public class REI_Calculations {
    ...
    public static double loan_payment(final double rate, final int term, final double present_value) {
    ...
    public static double calculate_dollar_amount(final double base_amount, final double percentage) {
    ...
    public static double full_loan_amount(double purchase_price_input,
    ...
    public static double monthly_rent(int num_units_input, double ave_rent_input){
        double tot_rent_month_auto = num_units_input * ave_rent_input;
        return tot_rent_month_auto;
    }

    public static double total_monthly_income(double tot_rent_month_auto, double other_income_month_input) {
        double tot_income_month_auto =tot_rent_month_auto + other_income_month_input;
        return tot_income_month_auto;
    }

    public static double future_value(double rate, int term, double payment, double present_value){
    ...
    public static double[] fixed_expenses_monthly(double electric, double WandS, double PMI, 
    ...
    public static double[] variable_expenses_monthly(double vacancy, double rep_and_main, 
    ...
    public static double cash_flow_monthly(double total_income_monthly, double payment, 
    ...
    public static double NOI_yearly(double total_income_monthly, double fixed_yearly, 
        double variable_yearly){
        // Calculates NOI
        double NOI = (total_income_monthly) - fixed_yearly - variable_yearly;
        return NOI;
    }
    public static double NIAF_yearly(double NOI, double payment){
        //Calculates the net income after financing (NIAF)
        double payment_yearly = payment * 12d;
        double NIAF = NOI - payment_yearly;
        return NIAF;
    }
    public static double cum_NIAF(double tot_NIAF, double NIAF){
        tot_NIAF += NIAF;
        return tot_NIAF;
    }
    public static double cash_to_close(double downpayment, double closing_costs, 
    ...
    public static double cash_on_cash_return(double NIAF, double cash_2_close){
        // Calculates the cash on cash return
        double CoCR = NIAF / cash_2_close;
        return CoCR * 100d;
    }
    public static double cap_rate(double NOI, double purchase_price, double rehab_budget, double closing_costs){
    ...
    public static double gross_rent_mult(double purchase_price, double rehab_budget, double total_income_monthly){
    ...
    public static double one_perc_rule(double purchase_price, double rehab_budget, double total_income_monthly){
    ...
    public static double fifty_perc_rule(double fixed_monthly, double var_monthly, double total_income_monthly){
        // Calculates the percentage of expenses to rent
        double percentage = (fixed_monthly + var_monthly) / (total_income_monthly);
        return percentage * 100d;
    }
    public static double future_equity(double fut_value_property, double fut_value_loan){
        // Calculates the future equity stake in property
        double tot_equity = fut_value_property - fut_value_loan;
        return tot_equity;
    }
    public static double tot_profit_sold(double fut_value_property, double selling_costs_perc,
    ...
    public static double growth_rate(double future_value, double present_value, int term_years){
        double CAGR = (Math.pow((future_value/present_value), 1d/term_years)-1) * 100d;
        return CAGR;
    }
    public static double return_on_investment(double final_tot_equity, double cum_NIAF, double cash_2_close){
